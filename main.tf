...
resource "vsphere_virtual_machine" "vm" {
  ...
  provisioner "local-exec" {
    command = "ansible-playbook -u '${var.ssh_user}' -i '${vsphere_virtual_machine.vm.default_ip_address},' --extra-vars '{'ansible_ssh_pass':'${var.ssh_password}','host_key_checking':'False'}' deploy_authorized_keys.yml"
  }
}
